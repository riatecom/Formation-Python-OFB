...
<img src="images/google-hits.png">
...
- **Récupérez le notebook Jupyter [`ogc-web-services.ipynb`](notebooks/ogc-web-services.ipynb) et ouvrez-le dans VSCodium.**

:::

# Partie 3 - Python et QGIS

<img src="images/QGIS_logo_2017.svg">
...
🚀 **Créez un nouveau projet QGIS, ajoutez les [données d'exemples]() et ouvrez la console Python.**
...
Il est possible de créer des algorithmes de traitement personnalisés en utilisant le module Python `processing`.
